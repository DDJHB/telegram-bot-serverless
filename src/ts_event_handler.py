...
from src.constructor.post_transaction_handlers.route_join_post_deposit import handle_tx_logs
...
def handler(event, context):
    try:
        ...
        if contract_name == "payment" and function_name == "deposit":
            handle_tx_logs(logs, transaction_data)
